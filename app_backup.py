...
color = "#20bebe"
LARGEFONT = ("Montserrat-Medium", 35, "bold")
...
class Page1(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label.grid(row = 0, column = 2, padx = 110, pady = 10)
        ...
        button1.grid(row = 8, column = 1, padx = 6, pady = 6)
        ...
        arith_button.grid(row = 6, column = 1, padx = 6, pady = 6)
